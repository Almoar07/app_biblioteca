<div>
    ...
    <div class="mx-auto px-16 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Gestión de editoriales</h1>
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                ...
                <div class="relative w-full md:w-64">
                    ...
                    <input type="text" wire:model.live="search" placeholder="Buscar editoriales..."
                ...
                <!-- Botón Añadir editorial -->
                <button wire:click="openPublisherModal('create', null)"
                    class="bg-blue-600
                        ...
                        <tr class="whitespace-nowrap">
                            <th
                                ...
                                <div class="flex items-center justify-between">
                                    <span>Nombre</span>
                                    <button wire:click="sortBy('nombre_editorial')" class="ml-2">
                                        <i
                                            class="fa-solid fa{{ $sortField === 'nombre_editorial' ? $icon : '-circle' }} text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors"></i>
                                    </button>
                                </div>
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @foreach ($publishers as $publisher)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700"
                                wire:key="publisher-{{ $publisher->id_editorial }}">
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                    {{ $publisher->nombre_editorial }}</td>




                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                    {{ $publisher->created_at->translatedFormat('j \d\e F \d\e Y \a \l\a\s H:i') }}
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <div class="flex gap-2">
                                        ...
                                        <a wire:click="openPublisherModal('edit',{{ $publisher->id_editorial }})"
                                        ...
                                        @if (auth()->user()->isAdmin())
                                            ...
                                            <button class="text-red-600 hover:text-red-900 dark:text-red-400"
                                                title="Eliminar"
                                                wire:click="showDeleteConfirmation({{ $publisher->id_editorial }}, '{{ $publisher->nombre_editorial }}')">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
